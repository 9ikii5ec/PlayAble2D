...
Bridge.assembly("UnityScriptsCompiler", function ($asm, globals) {
    ...
    Bridge.define("Build", {
        ...
        fields: {
            ...
            mergeTarget: null,
            mergingBuildings: null,
            IsDragging: false
        },
        props: {
            IsSnapping: {
                get: function () {
if ( TRACE ) { TRACE( "Build#IsSnapping#get", this ); }
            ...
            BuildingLevel: {
                get: function () {
if ( TRACE ) { TRACE( "Build#BuildingLevel#get", this ); }
...
if ( TRACE ) { TRACE( "Build#init", this ); }
                ...
                this.defaultPosition = new UnityEngine.Vector2();
                this.targetPosition = new UnityEngine.Vector3();
                this.mergeTarget = new UnityEngine.Vector3();
                this.snapSpeed = 10.0;
                this.mergeSpeed = 5.0;
                ...
                this.isInMergeProcess = false;
                this.mergingBuildings = new (System.Collections.Generic.List$1(Build)).ctor();
...
if ( TRACE ) { TRACE( "Build#Awake", this ); }
                ...
                this.defaultPosition = UnityEngine.Vector2.FromVector3(this.transform.position.$clone());
                this.targetPosition = this.transform.position.$clone();
                this.spriteRenderer = this.GetComponent(UnityEngine.SpriteRenderer);
                this.defaultSortingOrder = this.spriteRenderer.sortingOrder;
                this.buildGrid = UnityEngine.Object.FindObjectOfType(BuildGrid);
            },
            /*Build.Awake end.*/
...
if ( TRACE ) { TRACE( "Build#Update", this ); }
                ...
                var allMerged = true;
                $t = Bridge.getEnumerator(this.mergingBuildings);
                try {
                    while ($t.moveNext()) {
                        var build = $t.Current;
                        if (UnityEngine.MonoBehaviour.op_Inequality(build, this)) {
                            build.transform.position = new pc.Vec3().lerp( build.transform.position, this.mergeTarget, this.mergeSpeed * UnityEngine.Time.deltaTime );
                            if (pc.Vec3.distance( build.transform.position, this.mergeTarget ) > 0.01) {
                                allMerged = false;
                            }
                        }
                    }
...
if ( TRACE ) { TRACE( "Build#OnMouseDown", this ); }
                ...
                var $t;
                if (!this.isMerging && !this.isSnapping && !this.isInMergeProcess) {
...
if ( TRACE ) { TRACE( "Build#OnMouseUp", this ); }
                ...
                if (!this.isMerging && !this.isSnapping && !this.isInMergeProcess && this.isMovable) {
                    this.IsDragging = false;
                    this.SnapToCell();
                    this.spriteRenderer.sortingOrder = this.defaultSortingOrder;
                }
            },
            /*Build.OnMouseUp end.*/
...
if ( TRACE ) { TRACE( "Build#SnapToCell", this ); }
                ...
                this.defaultPosition = bestPosition.$clone();
                this.isSnapping = true;
            },
            /*Build.SnapToCell end.*/

            /*Build.IsBusyCell start.*/
            IsBusyCell: function (cellPosition) {
if ( TRACE ) { TRACE( "Build#IsBusyCell", this ); }

                var $t;
                var colliders = UnityEngine.Physics2D.OverlapCircleAll(cellPosition, 0.2);
                var array = colliders;
...
if ( TRACE ) { TRACE( "Build#GetMouseWorldPosition", this ); }
            ...
            /*Build.TryMerge start.*/
            TryMerge: function () {
if ( TRACE ) { TRACE( "Build#TryMerge", this ); }

                var $t;
                if (this.isInMergeProcess || this.isMerging) {
                    return;
                }
                var matchingNeighbors = this.GetMatchingNeighbors();
                if (matchingNeighbors.Count < 2) {
                    return;
                }
                var group = Bridge.fn.bind(this, function (_o1) {
                        _o1.add(this);
                        return _o1;
                    })(new (System.Collections.Generic.List$1(Build)).ctor());
                group.AddRange(matchingNeighbors);
                var leader = this.GetMergeLeader(group);
                if (UnityEngine.MonoBehaviour.op_Inequality(leader, this) || group.Exists(function (b) {
                    return b.isInMergeProcess;
                })) {
                    return;
                }
                ...
                this.mergingBuildings = group;
                this.mergeTarget = this.transform.position.$clone();
                this.isMerging = true;
            },
            /*Build.TryMerge end.*/

            /*Build.GetMatchingNeighbors start.*/
            GetMatchingNeighbors: function () {
if ( TRACE ) { TRACE( "Build#GetMatchingNeighbors", this ); }

                var $t;
                var matchingNeighbors = new (System.Collections.Generic.List$1(Build)).ctor();
                var colliders = UnityEngine.Physics2D.OverlapCircleAll(UnityEngine.Vector2.FromVector3(this.transform.position), 1.5);
                var array = colliders;
                $t = Bridge.getEnumerator(array);
                try {
                    while ($t.moveNext()) {
                        var collider = $t.Current;
                        if (UnityEngine.GameObject.op_Inequality(collider.gameObject, Bridge.ensureBaseProperty(this, "gameObject").$UnityEngine$Component$gameObject)) {
                            var otherBuild = collider.GetComponent(Build);
                            if (UnityEngine.MonoBehaviour.op_Inequality(otherBuild, null) && otherBuild.buildingLevel === this.buildingLevel) {
            ...
            /*Build.GetMatchingNeighbors end.*/

            /*Build.GetMergeLeader start.*/
            GetMergeLeader: function (builds) {
if ( TRACE ) { TRACE( "Build#GetMergeLeader", this ); }

                var $t;
                var leader = builds.getItem(0);
            ...
            /*Build.GetMergeLeader end.*/

            /*Build.CompleteMerge start.*/
            CompleteMerge: function () {
if ( TRACE ) { TRACE( "Build#CompleteMerge", this ); }
                ...
                try {
                    while ($t.moveNext()) {
                        ...
                        if (UnityEngine.MonoBehaviour.op_Inequality(build, this)) {
                            UnityEngine.Object.Destroy(build.gameObject);
                        }
                    }
                } finally {
                    if (Bridge.is($t, System.IDisposable)) {
                ...
                var nextLevel = (this.buildingLevel + 1) | 0;
                var newBuild = UnityEngine.Object.Instantiate$2(UnityEngine.GameObject, this.buildPrefab, this.mergeTarget, pc.Quat.IDENTITY.clone());
                newBuild.GetComponent(Build).buildingLevel = nextLevel;
            },
            /*Build.CompleteMerge end.*/

            /*Build.TryMergeNearby start.*/
            TryMergeNearby: function () {
if ( TRACE ) { TRACE( "Build#TryMergeNearby", this ); }

                var $t;
                var neighbors = this.GetMatchingNeighbors();
                this.TryMerge();
...
if ( TRACE ) { TRACE( "BuildGrid#CellPositions#get", this ); }
    ...
    Bridge.define("CameraMoving", {
        ...
        fields: {
            ...
            velocity: null,
            shouldMove: false,
            stage2Animation: null
        },
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "CameraMoving#init", this ); }
        ...
        methods: {
            /*CameraMoving.Awake start.*/
            Awake: function () {
if ( TRACE ) { TRACE( "CameraMoving#Awake", this ); }

                this.stage2Animation = UnityEngine.Object.FindObjectOfType(Stage2Animation);
            },
            /*CameraMoving.Awake end.*/

            /*CameraMoving.MoveTo start.*/
            MoveTo: function (position) {
if ( TRACE ) { TRACE( "CameraMoving#MoveTo", this ); }

                this.targetPosition = position.$clone().add( this.offset );
                this.shouldMove = true;
            },
            /*CameraMoving.MoveTo end.*/

            /*CameraMoving.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "CameraMoving#Update", this ); }

                if (this.shouldMove) {
                    this.transform.position = pc.Vec3.smoothDamp( this.transform.position.$clone(), this.targetPosition.$clone(), Bridge.ref(this, "velocity"), 1.0 / this.moveSpeed, Infinity, UnityEngine.Time.deltaTime );
                    if (pc.Vec3.distance( this.transform.position, this.targetPosition ) < 0.05) {
                        this.shouldMove = false;
                        this.stage2Animation.StartSequence();
                        this.stage2Animation.StartDisappearSequence();
                    }
                }
            },
            /*CameraMoving.Update end.*/
...
if ( TRACE ) { TRACE( "DG.Tweening.DOTweenModuleUtils.Physics#CreateDOTweenPathTween", this ); }
    ...
    Bridge.define("FadeScreen", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "FadeScreen#init", this ); }
        ...
        methods: {
            /*FadeScreen.Awake start.*/
            Awake: function () {
if ( TRACE ) { TRACE( "FadeScreen#Awake", this ); }

                var $t;
                if (UnityEngine.MonoBehaviour.op_Equality(this.fadePanel, null)) {
                    this.fadePanel = UnityEngine.GameObject.op_Inequality(($t = UnityEngine.GameObject.Find("FadePanel")), null) ? $t.GetComponent(UnityEngine.UI.Image) : null;
                }
                if (UnityEngine.MonoBehaviour.op_Inequality(this.fadePanel, null)) {
                    var color = this.fadePanel.color.$clone();
                    color.a = 0.0;
                    this.fadePanel.color = color.$clone();
                }
            },
            /*FadeScreen.Awake end.*/

            /*FadeScreen.FadeIn start.*/
            FadeIn: function (onComplete) {
if ( TRACE ) { TRACE( "FadeScreen#FadeIn", this ); }

                if (onComplete === void 0) { onComplete = null; }
                if (!this.isFading && UnityEngine.MonoBehaviour.op_Inequality(this.fadePanel, null)) {
                    this.StartCoroutine$1(this.Fade(0.0, 0.9, onComplete));
                }
            },
            /*FadeScreen.FadeIn end.*/

            /*FadeScreen.FadeOut start.*/
            FadeOut: function (onComplete) {
if ( TRACE ) { TRACE( "FadeScreen#FadeOut", this ); }

                if (onComplete === void 0) { onComplete = null; }
                if (!this.isFading && UnityEngine.MonoBehaviour.op_Inequality(this.fadePanel, null)) {
                    this.StartCoroutine$1(this.Fade(0.9, 0.0, onComplete));
                }
            },
            /*FadeScreen.FadeOut end.*/

            /*FadeScreen.Fade start.*/
            Fade: function (from, to, onComplete) {
if ( TRACE ) { TRACE( "FadeScreen#Fade", this ); }
                        ...
                        for (;;) {
                            switch ($step) {
                                case 0: {
                                    this.isFading = true;
                                        timer = 0.0;
                                        color = this.fadePanel.color.$clone();
                                    $step = 1;
                                    continue;
                                }
                                case 1: {
                                    if ( timer < this.fadeDuration ) {
                                            $step = 2;
                                            continue;
                                        } 
                                        $step = 4;
                                ...
                                case 2: {
                                    timer += UnityEngine.Time.deltaTime;
                                        t = timer / this.fadeDuration;
                                        color.a = pc.math.lerp(from, to, t);
                                        this.fadePanel.color = color.$clone();
    ...
    Bridge.define("FinalMerge", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "FinalMerge#init", this ); }

                this.isInteractble = true;
            }
        },
        methods: {
            /*FinalMerge.Awake start.*/
            Awake: function () {
if ( TRACE ) { TRACE( "FinalMerge#Awake", this ); }

                this.build = this.GetComponent(Build);
                this.collider = this.GetComponent(UnityEngine.Collider2D);
                this.cameraFollow = UnityEngine.Object.FindObjectOfType(CameraMoving);
                this.targetObject = UnityEngine.GameObject.FindWithTag("Target").transform;
            },
            /*FinalMerge.Awake end.*/

            /*FinalMerge.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "FinalMerge#Update", this ); }

                if (this.isInteractble) {
                    var distance = pc.Vec3.distance( this.transform.position, this.targetObject.position );
                    if (distance <= 1.0) {
                        this.build.isMovable = false;
                        this.build.enabled = false;
                        this.transform.position = new pc.Vec3().lerp( this.transform.position, this.targetObject.position, 10.0 * UnityEngine.Time.deltaTime );
                    }
                    if (distance <= 0.1) {
                        this.isInteractble = false;
                        this.collider.enabled = false;
                        UnityEngine.Object.Destroy(this.targetObject.gameObject);
                        this.cameraFollow.MoveTo(this.transform.position.$clone());
                    }
                }
            },
            /*FinalMerge.Update end.*/
    ...
    Bridge.define("HandAnimatin", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "HandAnimatin#init", this ); }

                this.handOffset = new UnityEngine.Vector3();
                this.showDelay = 1.0;
                this.handOffset = new pc.Vec3( 0.0, 1.0, 0.0 );
                this.timer = 0.0;
            }
        },
        methods: {
            /*HandAnimatin.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "HandAnimatin#Update", this ); }

                if (UnityEngine.MonoBehaviour.op_Equality(this.selectedBuild, null)) {
                    return;
                }
                this.timer += UnityEngine.Time.deltaTime;
                if (!this.selectedBuild.IsDragging) {
                    if (UnityEngine.GameObject.op_Inequality(this.currentHand, null)) {
                        UnityEngine.Object.Destroy(this.currentHand);
                    }
                    return;
                }
                ...
                if (UnityEngine.GameObject.op_Inequality(this.currentHand, null) && UnityEngine.MonoBehaviour.op_Inequality(this.targetBuild, null)) {
                    this.ShowHandAtTarget();
                }
            },
            /*HandAnimatin.Update end.*/

            /*HandAnimatin.TryShowHand start.*/
            TryShowHand: function () {
if ( TRACE ) { TRACE( "HandAnimatin#TryShowHand", this ); }

                var $t;
                var builds = UnityEngine.Object.FindObjectsOfType(Build);
                var array = builds;
                $t = Bridge.getEnumerator(array);
                try {
                    while ($t.moveNext()) {
                        var build = $t.Current;
                        if (UnityEngine.MonoBehaviour.op_Inequality(build, this.selectedBuild) && build.BuildingLevel === this.selectedBuild.BuildingLevel) {
            ...
            /*HandAnimatin.TryShowHand end.*/

            /*HandAnimatin.ShowHandAtTarget start.*/
            ShowHandAtTarget: function () {
if ( TRACE ) { TRACE( "HandAnimatin#ShowHandAtTarget", this ); }

                if (!(UnityEngine.GameObject.op_Inequality(this.currentHand, null))) {
                    var spawnPos = this.selectedBuild.transform.position.$clone().add( this.handOffset );
                    this.currentHand = UnityEngine.Object.Instantiate$2(UnityEngine.GameObject, this.handPrefab, spawnPos, pc.Quat.IDENTITY.clone());
                    var targetPos = this.targetBuild.transform.position.$clone();
                    var direction = targetPos.$clone().sub( this.selectedBuild.transform.position );
                    var angle = Math.atan2(direction.y, direction.x) * 57.29578;
                    this.currentHand.transform.rotation = new pc.Quat().setFromEulerAngles_Unity( 0.0, 0.0, angle );
                }
            },
            /*HandAnimatin.ShowHandAtTarget end.*/

            /*HandAnimatin.SetSelectedBuild start.*/
            SetSelectedBuild: function (build) {
if ( TRACE ) { TRACE( "HandAnimatin#SetSelectedBuild", this ); }

                this.selectedBuild = build;
            },
            /*HandAnimatin.SetSelectedBuild end.*/
    ...
    /*Handle start.*/
    Bridge.define("Handle", {
        inherits: [UnityEngine.MonoBehaviour]
    });
    /*Handle end.*/

    /*Stage2Animation start.*/
    Bridge.define("Stage2Animation", {
        inherits: [UnityEngine.MonoBehaviour],
        fields: {
            objectsToAppear: null,
            appearDelay: 0,
            appearRiseDistance: 0,
            appearDuration: 0,
            objectsToDisappear: null,
            disappearDelay: 0,
            disappearRiseDistance: 0,
            disappearDuration: 0,
            fadeScreen: null
        },
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "Stage2Animation#init", this ); }

                this.objectsToAppear = new (System.Collections.Generic.List$1(UnityEngine.GameObject)).ctor();
                this.appearDelay = 0.2;
                this.appearRiseDistance = 1.0;
                this.appearDuration = 1.0;
                this.objectsToDisappear = new (System.Collections.Generic.List$1(UnityEngine.GameObject)).ctor();
                this.disappearDelay = 0.2;
                this.disappearRiseDistance = 1.0;
                this.disappearDuration = 1.0;
            }
        },
        methods: {
            /*Stage2Animation.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "Stage2Animation#Start", this ); }

                this.fadeScreen = UnityEngine.Object.FindObjectOfType(FadeScreen);
            },
            /*Stage2Animation.Start end.*/

            /*Stage2Animation.StartSequence start.*/
            StartSequence: function () {
if ( TRACE ) { TRACE( "Stage2Animation#StartSequence", this ); }

                this.StartCoroutine$1(this.AppearSequence());
            },
            /*Stage2Animation.StartSequence end.*/

            /*Stage2Animation.StartDisappearSequence start.*/
            StartDisappearSequence: function () {
if ( TRACE ) { TRACE( "Stage2Animation#StartDisappearSequence", this ); }

                this.StartCoroutine$1(this.DisappearSequence());
            },
            /*Stage2Animation.StartDisappearSequence end.*/

            /*Stage2Animation.AppearSequence start.*/
            AppearSequence: function () {
if ( TRACE ) { TRACE( "Stage2Animation#AppearSequence", this ); }
                    ...
                    try {
                        for (;;) {
                            switch ($step) {
                                ...
                                case 1: {
                                    if ( i < this.objectsToAppear.Count ) {
                                            $step = 2;
                                            continue;
                                        }
                                    $step = 7;
                                ...
                                case 2: {
                                    obj = this.objectsToAppear.getItem(i);
                                ...
                                case 3: {
                                    this.StartCoroutine$1(this.Appear(obj));
                                        $enumerator.current = new UnityEngine.WaitForSeconds(this.appearDelay);
                                        $step = 4;
                                        return true;
                                }
                                case 4: {
                                ...
                                case 7: {
                                    $enumerator.current = new UnityEngine.WaitForSeconds(this.appearDuration + 0.6);
                                        $step = 8;
                                        return true;
                                }
                                case 8: {
                                    if (UnityEngine.MonoBehaviour.op_Inequality(this.fadeScreen, null)) {
                                            this.fadeScreen.FadeIn(function () {
                                                UnityEngine.Debug.Log$1("\u041f\u043e\u044f\u0432\u043b\u0435\u043d\u0438\u0435 \u0437\u0430\u0432\u0435\u0440\u0448\u0435\u043d\u043e \u0438 \u044d\u043a\u0440\u0430\u043d \u0437\u0430\u0442\u0435\u043c\u043d\u0451\u043d");
                                            });
                                        }
            ...
            /*Stage2Animation.AppearSequence end.*/

            /*Stage2Animation.DisappearSequence start.*/
            DisappearSequence: function () {
if ( TRACE ) { TRACE( "Stage2Animation#DisappearSequence", this ); }
                ...
                var $enumerator = new Bridge.GeneratorEnumerator(Bridge.fn.bind(this, function () {
                    try {
                        for (;;) {
                            switch ($step) {
                                case 0: {
                                    i = (this.objectsToDisappear.Count - 1) | 0;
                                        $step = 1;
                                        continue;
                                }
                                case 1: {
                                ...
                                case 2: {
                                    obj = this.objectsToDisappear.getItem(i);
                                        if (UnityEngine.GameObject.op_Inequality(obj, null)) {
                                            $step = 3;
                                            continue;
                                        } 
                                ...
                                case 3: {
                                    this.StartCoroutine$1(this.Disappear(obj));
                                        $enumerator.current = new UnityEngine.WaitForSeconds(this.disappearDelay);
                                        $step = 4;
                                        return true;
                                }
                                case 4: {
            ...
            /*Stage2Animation.DisappearSequence end.*/

            /*Stage2Animation.Appear start.*/
            Appear: function (obj) {
if ( TRACE ) { TRACE( "Stage2Animation#Appear", this ); }
                ...
                var $enumerator = new Bridge.GeneratorEnumerator(Bridge.fn.bind(this, function () {
                    try {
                        for (;;) {
                            switch ($step) {
                                case 0: {
                                    sr = obj.GetComponent(UnityEngine.SpriteRenderer);
                                        endPos = obj.transform.position.$clone();
                                        startPos = endPos.$clone().add( pc.Vec3.UP.clone().clone().scale( this.appearRiseDistance ) );
                                        obj.transform.position = startPos.$clone();
                                        if (UnityEngine.Component.op_Inequality(sr, null)) {
                                            color2 = sr.color.$clone();
                                            color2.a = 0.0;
                                            sr.color = color2.$clone();
                                        }
                                        timer = 0.0;
                                    $step = 1;
                                    continue;
                                ...
                                case 2: {
                                    timer += UnityEngine.Time.deltaTime;
                                        t = timer / this.appearDuration;
                                        obj.transform.position = new pc.Vec3().lerp( startPos, endPos, t );
                                        if (UnityEngine.Component.op_Inequality(sr, null)) {
                                            color = sr.color.$clone();
                                            color.a = pc.math.lerp(0.0, 1.0, t);
                                            sr.color = color.$clone();
                                        }
                                        $enumerator.current = null;
                                        $step = 3;
                                        return true;
            ...
            /*Stage2Animation.Appear end.*/

            /*Stage2Animation.Disappear start.*/
            Disappear: function (obj) {
if ( TRACE ) { TRACE( "Stage2Animation#Disappear", this ); }
                    ...
                    try {
                        for (;;) {
                            switch ($step) {
                                case 0: {
                                    sr = obj.GetComponent(UnityEngine.SpriteRenderer);
                                        startPos = obj.transform.position.$clone();
                                        endPos = startPos.$clone().add( pc.Vec3.UP.clone().clone().scale( this.disappearRiseDistance ) );
                                        timer = 0.0;
                                    $step = 1;
                                    continue;
                                }
                                case 1: {
                                    if ( timer < this.disappearDuration ) {
                                            $step = 2;
                                            continue;
                                        } 
                                        $step = 4;
                                ...
                                case 2: {
                                    timer += UnityEngine.Time.deltaTime;
                                        t = timer / this.disappearDuration;
                                        obj.transform.position = new pc.Vec3().lerp( startPos, endPos, t );
                                        if (UnityEngine.Component.op_Inequality(sr, null)) {
                                            color = sr.color.$clone();
    ...
    /*Build start.*/
    $m("Build", function () { return {"att":1048577,"a":2,"at":[new UnityEngine.RequireComponent.ctor(UnityEngine.Collider2D),new UnityEngine.RequireComponent.ctor(UnityEngine.SpriteRenderer)],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":1,"n":"CompleteMerge","t":8,"sn":"CompleteMerge","rt":$n[0].Void},{"a":1,"n":"GetMatchingNeighbors","t":8,"sn":"GetMatchingNeighbors","rt":$n[1].List$1(Build)},{"a":1,"n":"GetMergeLeader","t":8,"pi":[{"n":"builds","pt":$n[1].List$1(Build),"ps":0}],"sn":"GetMergeLeader","rt":Build,"p":[$n[1].List$1(Build)]},{"a":1,"n":"GetMouseWorldPosition","t":8,"sn":"GetMouseWorldPosition","rt":$n[2].Vector3},{"a":1,"n":"IsBusyCell","t":8,"pi":[{"n":"cellPosition","pt":$n[2].Vector2,"ps":0}],"sn":"IsBusyCell","rt":$n[0].Boolean,"p":[$n[2].Vector2],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"OnMouseDown","t":8,"sn":"OnMouseDown","rt":$n[0].Void},{"a":1,"n":"OnMouseDrag","t":8,"sn":"OnMouseDrag","rt":$n[0].Void},{"a":1,"n":"OnMouseUp","t":8,"sn":"OnMouseUp","rt":$n[0].Void},{"a":1,"n":"SnapToCell","t":8,"sn":"SnapToCell","rt":$n[0].Void},{"a":1,"n":"TryMerge","t":8,"sn":"TryMerge","rt":$n[0].Void},{"a":1,"n":"TryMergeNearby","t":8,"sn":"TryMergeNearby","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":2,"n":"BuildingLevel","t":16,"rt":$n[0].Int32,"g":{"a":2,"n":"get_BuildingLevel","t":8,"rt":$n[0].Int32,"fg":"BuildingLevel","box":function ($v) { return Bridge.box($v, System.Int32);}},"fn":"BuildingLevel"},{"a":2,"n":"IsDragging","t":16,"rt":$n[0].Boolean,"g":{"a":2,"n":"get_IsDragging","t":8,"rt":$n[0].Boolean,"fg":"IsDragging","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},"s":{"a":1,"n":"set_IsDragging","t":8,"p":[$n[0].Boolean],"rt":$n[0].Void,"fs":"IsDragging"},"fn":"IsDragging"},{"a":2,"n":"IsSnapping","t":16,"rt":$n[0].Boolean,"g":{"a":2,"n":"get_IsSnapping","t":8,"rt":$n[0].Boolean,"fg":"IsSnapping","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},"fn":"IsSnapping"},{"a":1,"n":"__Property__Initializer__IsDragging","t":4,"rt":$n[0].Boolean,"sn":"__Property__Initializer__IsDragging","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"buildGrid","t":4,"rt":BuildGrid,"sn":"buildGrid"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"buildPrefab","t":4,"rt":$n[2].GameObject,"sn":"buildPrefab"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"buildingLevel","t":4,"rt":$n[0].Int32,"sn":"buildingLevel","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"defaultPosition","t":4,"rt":$n[2].Vector2,"sn":"defaultPosition"},{"a":1,"n":"defaultSortingOrder","t":4,"rt":$n[0].Int32,"sn":"defaultSortingOrder","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"isInMergeProcess","t":4,"rt":$n[0].Boolean,"sn":"isInMergeProcess","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"isMerging","t":4,"rt":$n[0].Boolean,"sn":"isMerging","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"isMovable","t":4,"rt":$n[0].Boolean,"sn":"isMovable","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"isSnapping","t":4,"rt":$n[0].Boolean,"sn":"isSnapping","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"mergeSpeed","t":4,"rt":$n[0].Single,"sn":"mergeSpeed","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"mergeTarget","t":4,"rt":$n[2].Vector3,"sn":"mergeTarget"},{"a":1,"n":"mergingBuildings","t":4,"rt":$n[1].List$1(Build),"sn":"mergingBuildings"},{"a":1,"n":"offset","t":4,"rt":$n[2].Vector3,"sn":"offset"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"snapSpeed","t":4,"rt":$n[0].Single,"sn":"snapSpeed","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"spriteRenderer","t":4,"rt":$n[2].SpriteRenderer,"sn":"spriteRenderer"},{"a":1,"n":"targetPosition","t":4,"rt":$n[2].Vector3,"sn":"targetPosition"},{"a":1,"backing":true,"n":"<IsDragging>k__BackingField","t":4,"rt":$n[0].Boolean,"sn":"IsDragging","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}}]}; }, $n);
    /*Build end.*/

    /*BuildGrid start.*/
    $m("BuildGrid", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"CellPositions","t":16,"rt":$n[1].List$1(UnityEngine.Vector2),"g":{"a":2,"n":"get_CellPositions","t":8,"rt":$n[1].List$1(UnityEngine.Vector2),"fg":"CellPositions"},"fn":"CellPositions"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"cells","t":4,"rt":$n[1].List$1(UnityEngine.Transform),"sn":"cells"}]}; }, $n);
    /*BuildGrid end.*/

    /*CameraMoving start.*/
    $m("CameraMoving", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":2,"n":"MoveTo","t":8,"pi":[{"n":"position","pt":$n[2].Vector3,"ps":0}],"sn":"MoveTo","rt":$n[0].Void,"p":[$n[2].Vector3]},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"moveSpeed","t":4,"rt":$n[0].Single,"sn":"moveSpeed","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"offset","t":4,"rt":$n[2].Vector3,"sn":"offset"},{"a":1,"n":"shouldMove","t":4,"rt":$n[0].Boolean,"sn":"shouldMove","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"stage2Animation","t":4,"rt":Stage2Animation,"sn":"stage2Animation"},{"a":1,"n":"targetPosition","t":4,"rt":$n[2].Vector3,"sn":"targetPosition"},{"a":1,"n":"velocity","t":4,"rt":$n[2].Vector3,"sn":"velocity"}]}; }, $n);
    /*CameraMoving end.*/

    /*FadeScreen start.*/
    $m("FadeScreen", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":1,"n":"Fade","t":8,"pi":[{"n":"from","pt":$n[0].Single,"ps":0},{"n":"to","pt":$n[0].Single,"ps":1},{"n":"onComplete","pt":Function,"ps":2}],"sn":"Fade","rt":$n[3].IEnumerator,"p":[$n[0].Single,$n[0].Single,Function]},{"a":2,"n":"FadeIn","t":8,"pi":[{"n":"onComplete","dv":null,"o":true,"pt":Function,"ps":0}],"sn":"FadeIn","rt":$n[0].Void,"p":[Function]},{"a":2,"n":"FadeOut","t":8,"pi":[{"n":"onComplete","dv":null,"o":true,"pt":Function,"ps":0}],"sn":"FadeOut","rt":$n[0].Void,"p":[Function]},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"fadeDuration","t":4,"rt":$n[0].Single,"sn":"fadeDuration","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"fadePanel","t":4,"rt":$n[4].Image,"sn":"fadePanel"},{"a":1,"n":"isFading","t":4,"rt":$n[0].Boolean,"sn":"isFading","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}}]}; }, $n);
    /*FadeScreen end.*/

    /*FinalMerge start.*/
    $m("FinalMerge", function () { return {"att":1048577,"a":2,"at":[new UnityEngine.RequireComponent.ctor(Build)],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"build","t":4,"rt":Build,"sn":"build"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"cameraFollow","t":4,"rt":CameraMoving,"sn":"cameraFollow"},{"a":1,"n":"collider","t":4,"rt":$n[2].Collider2D,"sn":"collider"},{"a":1,"n":"isInteractble","t":4,"rt":$n[0].Boolean,"sn":"isInteractble","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"targetObject","t":4,"rt":$n[2].Transform,"sn":"targetObject"}]}; }, $n);
    /*FinalMerge end.*/

    /*HandAnimatin start.*/
    $m("HandAnimatin", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"SetSelectedBuild","t":8,"pi":[{"n":"build","pt":Build,"ps":0}],"sn":"SetSelectedBuild","rt":$n[0].Void,"p":[Build]},{"a":1,"n":"ShowHandAtTarget","t":8,"sn":"ShowHandAtTarget","rt":$n[0].Void},{"a":1,"n":"TryShowHand","t":8,"sn":"TryShowHand","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"currentHand","t":4,"rt":$n[2].GameObject,"sn":"currentHand"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"handOffset","t":4,"rt":$n[2].Vector3,"sn":"handOffset"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"handPrefab","t":4,"rt":$n[2].GameObject,"sn":"handPrefab"},{"a":1,"n":"selectedBuild","t":4,"rt":Build,"sn":"selectedBuild"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"showDelay","t":4,"rt":$n[0].Single,"sn":"showDelay","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"targetBuild","t":4,"rt":Build,"sn":"targetBuild"},{"a":1,"n":"timer","t":4,"rt":$n[0].Single,"sn":"timer","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*HandAnimatin end.*/

    /*Handle start.*/
    $m("Handle", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"}]}; }, $n);
    /*Handle end.*/

    /*Stage2Animation start.*/
    $m("Stage2Animation", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Appear","t":8,"pi":[{"n":"obj","pt":$n[2].GameObject,"ps":0}],"sn":"Appear","rt":$n[3].IEnumerator,"p":[$n[2].GameObject]},{"a":1,"n":"AppearSequence","t":8,"sn":"AppearSequence","rt":$n[3].IEnumerator},{"a":1,"n":"Disappear","t":8,"pi":[{"n":"obj","pt":$n[2].GameObject,"ps":0}],"sn":"Disappear","rt":$n[3].IEnumerator,"p":[$n[2].GameObject]},{"a":1,"n":"DisappearSequence","t":8,"sn":"DisappearSequence","rt":$n[3].IEnumerator},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"StartDisappearSequence","t":8,"sn":"StartDisappearSequence","rt":$n[0].Void},{"a":2,"n":"StartSequence","t":8,"sn":"StartSequence","rt":$n[0].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"appearDelay","t":4,"rt":$n[0].Single,"sn":"appearDelay","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"appearDuration","t":4,"rt":$n[0].Single,"sn":"appearDuration","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"appearRiseDistance","t":4,"rt":$n[0].Single,"sn":"appearRiseDistance","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"disappearDelay","t":4,"rt":$n[0].Single,"sn":"disappearDelay","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"disappearDuration","t":4,"rt":$n[0].Single,"sn":"disappearDuration","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"disappearRiseDistance","t":4,"rt":$n[0].Single,"sn":"disappearRiseDistance","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"fadeScreen","t":4,"rt":FadeScreen,"sn":"fadeScreen"},{"at":[new UnityEngine.HeaderAttribute("\u041f\u043e\u044f\u0432\u043b\u0435\u043d\u0438\u0435 \u043e\u0431\u044a\u0435\u043a\u0442\u043e\u0432"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"objectsToAppear","t":4,"rt":$n[1].List$1(UnityEngine.GameObject),"sn":"objectsToAppear"},{"at":[new UnityEngine.HeaderAttribute("\u0418\u0441\u0447\u0435\u0437\u043d\u043e\u0432\u0435\u043d\u0438\u0435 \u043e\u0431\u044a\u0435\u043a\u0442\u043e\u0432"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"objectsToDisappear","t":4,"rt":$n[1].List$1(UnityEngine.GameObject),"sn":"objectsToDisappear"}]}; }, $n);
    /*Stage2Animation end.*/
